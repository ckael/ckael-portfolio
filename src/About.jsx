                ...
                <Grid className="About" item lg={8} padding={3} letterSpacing={3} xs={12} md={8} sm={12}  >
                    ...
                    <Grid container alignItems="center">
                        ...
                        <Grid item lg={3} md={3} sm={12} xs={12}>
                            <ButtonGroup >
                                <IconButton color="primary" href="https://github.com/ckael" target="_blank" rel="noopener noreferrer"><GitHub /></IconButton>
                                <IconButton color="primary" href="https://www.facebook.com/mockael.ranaivomanana?eav=AfYTuiInrHkqs9mylCNkwCOoC3kKmxhI5QMA5j79XX0lj0rOQG-zoGVDeE3P-GKkngg&paipv=0&_rdc=1&_rdr" target="_blank" rel="noopener noreferrer"><FacebookRounded /></IconButton>
                                <IconButton color="primary" href="https://www.linkedin.com/in/riantsoa-ckael-ranaivomanana-7706892a8/" target="_blank" rel="noopener noreferrer"><LinkedIn /></IconButton>
                            </ButtonGroup>
                        </Grid>
                    </Grid>
                </Grid>
